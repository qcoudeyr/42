...
/*   Updated: 2024/01/10 16:14:59 by  qcoudeyr        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	lib->no.ptr = mlx_png_file_to_image(lib->mlx, lib->no.fname, &lib->no.w, &lib->no.h);
	lib->so.ptr = mlx_png_file_to_image(lib->mlx, lib->so.fname, &lib->so.w, &lib->so.h);
	lib->ea.ptr = mlx_png_file_to_image(lib->mlx, lib->ea.fname, &lib->ea.w, &lib->ea.h);
	lib->we.ptr = mlx_png_file_to_image(lib->mlx, lib->we.fname, &lib->we.w, &lib->we.h);
