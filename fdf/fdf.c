...
/*   Updated: 2023/09/05 14:00:15 by  qcoudeyr        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	keyhandle(int keycode, t_mlx *lib)
{
	...
	if (keycode == 115)
 	...
 	if (keycode == 99)
		mlx_string_put(lib->mlx, lib->current_win, 500, 300, trgb(0,255,0,0), "Ceci est un test /");
