...
/*   Updated: 2023/09/08 14:05:13 by  qcoudeyr        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	put_dot(&lib->data, (first->x * lib->scalex), (first->y * lib->scaley), tcolor(first->value,0,0));
	put_dot(&lib->data, (second->x * lib->scalex), (second->y * lib->scaley), tcolor(second->value,0,0));
