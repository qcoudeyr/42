...
/*   Updated: 2023/09/08 14:06:01 by  qcoudeyr        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	put_dot(&lib->data, (first->y * lib->scalex), (first->x * lib->scaley)tcolor(first->value,0,0));
	put_dot(&lib->data, (second->x * lib->scaley), (second->y * lib->scalex), tcolor(second->value,0,0));
